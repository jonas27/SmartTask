package com.smarttask17.joe.smarttask.signUp;
...
//        //SignUpDataChecker checkData = new SignUpDataChecker(this);
//        if (SignUpDataChecker.controlSignUpArray(dataString, SignUpActivity.this)) {
